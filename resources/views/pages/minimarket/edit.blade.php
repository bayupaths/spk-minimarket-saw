...
@section('title')
    Data Minimarket - Update Data Minimarket
@endsection
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">Update Data Minimarket</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('minimarket.update', $minimarket->id) }}" method="post"
